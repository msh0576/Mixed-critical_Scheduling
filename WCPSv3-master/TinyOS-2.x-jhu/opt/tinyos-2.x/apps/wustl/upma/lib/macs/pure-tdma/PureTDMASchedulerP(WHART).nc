...
implementation {
	...
	uint8_t schedule[50][12]={//Source Routing, 16 sensor topology, 2 prime trans, retrans twice, baseline.
		...
		{3, 1, 3, 22, 0, 1, 1, 1, 0, 0, 1, 2},

		{4, 3, 4, 22, 0, 1, 1, 1, 0, 0, 2, 0},
		{5, 3, 4, 22, 0, 1, 1, 1, 0, 0, 2, 1},
		{6, 3, 4, 22, 0, 1, 1, 1, 0, 0, 2, 2},

		{7, 4, 51, 22, 0, 1, 1, 1, 0, 0, 3, 0},
		{8, 4, 51, 22, 0, 1, 1, 1, 0, 0, 3, 1},
		{9, 4, 51, 22, 0, 1, 1, 1, 0, 0, 3, 2}
		*/
		...
		{4, 1, 3, 22, 0, 1, 1, 1, 0, 0, 1, 2},

		{5, 3, 4, 22, 0, 1, 1, 1, 0, 0, 2, 0},
		{6, 3, 4, 22, 0, 1, 1, 1, 0, 0, 2, 1},
		{7, 3, 4, 22, 0, 1, 1, 1, 0, 0, 2, 2},

		{8, 4, 5, 22, 0, 1, 1, 1, 0, 0, 3, 0},
		{9, 4, 5, 22, 0, 1, 1, 1, 0, 0, 3, 1},
		{10, 4, 5, 22, 0, 1, 1, 1, 0, 0, 3, 2},

		{11, 5, 6, 22, 0, 1, 1, 1, 0, 0, 4, 0},
		{12, 5, 6, 22, 0, 1, 1, 1, 0, 0, 4, 1},
		{13, 5, 6, 22, 0, 1, 1, 1, 0, 0, 4, 2},

		{14, 6, 51, 22, 0, 1, 1, 1, 0, 0, 5, 0},
		{15, 6, 51, 22, 0, 1, 1, 1, 0, 0, 5, 1},
