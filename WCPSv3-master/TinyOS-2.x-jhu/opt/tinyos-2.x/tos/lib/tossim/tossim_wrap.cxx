...
//added by sihoon
SWIGINTERN PyObject *_wrap_Tossim_sendVirtualSchedule(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Tossim *arg1 = (Tossim *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:Tossim_sendVirtualSchedule",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Tossim, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Tossim_sendVirtualSchedule" "', argument " "1"" of type '" "Tossim *""'");
  }
  arg1 = reinterpret_cast< Tossim * >(argp1);
  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Tossim_sendVirtualSchedule" "', argument " "2"" of type '" "int""'");
  }
  arg2 = static_cast< int >(val2);
  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Tossim_sendVirtualSchedule" "', argument " "3"" of type '" "int""'");
  }
  arg3 = static_cast< int >(val3);
  ecode4 = SWIG_AsVal_int(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "Tossim_sendVirtualSchedule" "', argument " "4"" of type '" "int""'");
  }
  arg4 = static_cast< int >(val4);
  ecode5 = SWIG_AsVal_int(obj4, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "Tossim_sendVirtualSchedule" "', argument " "5"" of type '" "int""'");
  }
  arg5 = static_cast< int >(val5);
  (arg1)->sendVirtualSchedule(arg2,arg3,arg4,arg5);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
...
SWIGINTERN PyObject *_wrap_Tossim_sendTaskPeriods(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  PyObject *resultobj = 0;
  Tossim *arg1 = (Tossim *) 0 ;
  int arg2 ;
  int arg3 ;
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOO:Tossim_sendTaskPeriods",&obj0,&obj1,&obj2,&obj3,&obj4)) SWIG_fail;
  res1 = SWIG_ConvertPtr(obj0, &argp1,SWIGTYPE_p_Tossim, 0 |  0 );
  if (!SWIG_IsOK(res1)) {
    SWIG_exception_fail(SWIG_ArgError(res1), "in method '" "Tossim_sendTaskPeriods" "', argument " "1"" of type '" "Tossim *""'");
  }
  arg1 = reinterpret_cast< Tossim * >(argp1);

  ecode2 = SWIG_AsVal_int(obj1, &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "Tossim_sendTaskPeriods" "', argument " "2"" of type '" "int""'");
  }
  arg2 = static_cast< int >(val2);

  ecode3 = SWIG_AsVal_int(obj2, &val3);
  if (!SWIG_IsOK(ecode3)) {
    SWIG_exception_fail(SWIG_ArgError(ecode3), "in method '" "Tossim_sendTaskPeriods" "', argument " "3"" of type '" "int""'");
  }
  arg3 = static_cast< int >(val3);

  ecode4 = SWIG_AsVal_int(obj3, &val4);
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "Tossim_sendTaskPeriods" "', argument " "4"" of type '" "int""'");
  }
  arg4 = static_cast< int >(val4);

  ecode5 = SWIG_AsVal_int(obj4, &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "Tossim_sendTaskPeriods" "', argument " "5"" of type '" "int""'");
  }
  arg5 = static_cast< int >(val5);

  (arg1)->sendTaskPeriods(arg2,arg3,arg4,arg5);
  resultobj = SWIG_Py_Void();
  return resultobj;
fail:
  return NULL;
