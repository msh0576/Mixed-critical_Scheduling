...
#line 742
typedef int (*__compar_fn_t)(const void *arg_0x2b363c9d9cf8, const void *arg_0x2b363c9d8020);
#line 780
__extension__ 
#line 797
__extension__ 
...
#line 250
extern double erfc(double arg_0x2b363ca5c618) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 326
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0x2b363cca7ca8), 
int (*key_eq_fn)(void *arg_0x2b363ccbe4e8, void *arg_0x2b363ccbe788));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0x2b363cef0ce0, int arg_0x2b363ceee020);
static double RandomUniform(void );
...
static uint32_t PureTDMASchedulerP__SuperframeLength(uint32_t Task_set[][3]);
...
#line 230
  sim_log_debug(221U, "Packet", "Delivering packet to %i at %s\n", (int )sim_node(), sim_time_string());
...
#line 49
# 764 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__set_current_hop_status(uint32_t slot_t, uint8_t sender, uint8_t receiver)
#line 764
{
  uint8_t i;
...
#line 77
# 590 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__SubReceive__receive(message_t *msg, void *payload, uint8_t len)
#line 590
{
...
#line 656
              ...
              if (PureTDMASchedulerP__isFlowdest[sim_node()] == TRUE) {
                  ...
                  sim_log_debug_clear(130U, "E2E_delay_Log_data", "%d %d %d %d ", TOS_NODE_ID, flow_id_rcv, PureTDMASchedulerP__rcv_count[sim_node()][flow_id_rcv], PureTDMASchedulerP__Total_frame_count[sim_node()][flow_id_rcv]);
                  for (i = 0; i < PureTDMASchedulerP__superframe_length[sim_node()]; i++) {
                      sim_log_debug_clear(131U, "E2E_delay_Log_data", "%d ", PureTDMASchedulerP__e2e_delay_buffer[sim_node()][flow_id_rcv][i]);
                    }
                  sim_log_debug_clear(132U, "E2E_delay_Log_data", "\n");



                  if (TOS_NODE_ID == 51) {
                      sim_log_debug_clear(133U, "check_link_quality", "RxCount: %d\n", PureTDMASchedulerP__rcv_count[sim_node()][1]);
                    }
                }
            }
        }
...
# 67 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0x2b363dc86a90, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  __nesc_result = SyncReceiveAdapterP__Receive__receive(arg_0x2b363dc86a90, msg, payload, len);
#line 67
...
#line 59
# 774 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__set_send(uint32_t slot_t)
#line 774
{
  uint8_t i;
...
#line 802
              ...
              if (TOS_NODE_ID == 1) {
                  sim_log_debug_clear(135U, "check_link_quality", "Nodeid: %d TxCount: %d\n", TOS_NODE_ID, PureTDMASchedulerP__Total_tx_count[sim_node()][1]);
                }
...
# 124 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * SyncSendAdapterP__AMSend__getPayload(am_id_t arg_0x2b363dc4f448, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = TossimActiveMessageC__AMSend__getPayload(arg_0x2b363dc4f448, msg, len);
#line 124
...
#line 335
  ...
  if (Interf_Check[3] != PureTDMASchedulerP__temp_interf[sim_node()]) {
      ...
      sim_log_debug_clear(119U, "Task_T_Test", "maxReTx - T1:%d / T2:%d\r\n", PureTDMASchedulerP__My_max_txopper[sim_node()][1], PureTDMASchedulerP__My_max_txopper[sim_node()][2]);
    }

  if (Dist_Check[3] != PureTDMASchedulerP__temp_dist[sim_node()]) {
      PureTDMASchedulerP__temp_dist[sim_node()] = Dist_Check[3];
      sim_log_debug_clear(120U, "Util_Log_data", "-----Disturbance-----\n");
      ...
      sim_log_debug(121U, "Task_T_Test", "T1:%d, T2:%d\n", Dist_Check[0], Dist_Check[1]);
      sim_log_debug(122U, "Task_T_Test", "Superframe:%lu\n", PureTDMASchedulerP__superframe_length[sim_node()]);
    }
  ...
  if (slot == 0) {
      if (PureTDMASchedulerP__coordinatorId[sim_node()] == TOS_NODE_ID) {
          ...
          sim_log_debug(123U, "printf", "SENSOR: %u has done network synchronization in SLOT: %u at time: %s:\n", TOS_NODE_ID, slot, sim_time_string());
        }
#line 372
      ;
      return;
  ...
  if (slot % PureTDMASchedulerP__superframe_length[sim_node()] == 0) {
      if (1 == TOS_NODE_ID) {
          sim_log_debug(124U, "transmission", "SF-------------\n");
        }
      ;
...
#line 32
# 978 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline uint32_t PureTDMASchedulerP__getLCD(uint32_t num1, uint32_t num2)
#line 978
{
...
# 99 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0x2b363dc89850, message_t * msg, error_t error){
#line 99
  SyncSendAdapterP__AMSend__sendDone(arg_0x2b363dc89850, msg, error);
#line 99
}
#line 99
...
#line 192
{
  sim_log_debug(150U, "test", "GenericSlotSenderP. sendDone\n");
}
...
#line 367
        ...
        sim_log_debug(165U, "TossimPacketModelC", "PACKET: Failed to send packet due to busy channel.\n");
...
#line 161
{
  ...
  sim_log_debug(158U, "TossimPacketModelC", "Packet.send()\n");
...
#line 70
  sim_log_debug(217U, "AM", "AM: Sending packet (id=%hhu, len=%hhu) to %hu\n", id, len, addr);
...
# 69 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t SyncSendAdapterP__AMSend__send(am_id_t arg_0x2b363dc4f448, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0x2b363dc4f448, addr, msg, len);
#line 69
...
#line 74
# 502 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__SubSend__sendDone(message_t *msg, error_t error)
#line 502
{
...
#line 506
  ...
  if (ack_at_send_done == 0) {
      ...
      if (PureTDMASchedulerP__Tx_count[sim_node()][PureTDMASchedulerP__Transmitting_flowid[sim_node()]] == PureTDMASchedulerP__My_max_txopper[sim_node()][PureTDMASchedulerP__Transmitting_flowid[sim_node()]]) {
          sim_log_debug(128U, "transmission", "NoACK:Reset Tx/Rx status -- Transmitting_flowid:%d\n", PureTDMASchedulerP__Transmitting_flowid[sim_node()]);
...
# 48 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/interfaces/AsyncSend.nc"
inline static void SenderDispatcherP__Send__sendDone(uint8_t arg_0x2b363d8af6d8, message_t * msg, error_t error){
#line 48
  switch (arg_0x2b363d8af6d8) {
#line 48
    case TDMA_SLOT:
#line 48
...
#line 48
    default:
#line 48
      SenderDispatcherP__Send__default__sendDone(arg_0x2b363d8af6d8, msg, error);
#line 48
      break;
#line 48
    }
...
#line 79
# 703 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__CCAevent__anypktreceive(void )
#line 703
{
...
#line 361
{
  ...
  sim_log_debug(180U, "PHY_layer_check", " PHY reception---\n");



  sim_log_debug(181U, "CpmModelC", "Handling reception event @ %s.\n", sim_time_string());
  while (list != (void *)0) {
      if (list->next == mine) {
          predecessor = list;
        }
...
#line 381
    if (mine == CpmModelC__outstandingReceptionHead[sim_node()]) {
        ...
        sim_log_error(182U, "CpmModelC", "Incoming packet list structure is corrupted: entry is not the head and no entry points to it.\n");
      }
    }
  sim_log_debug(183U, "CpmModelC,SNRLoss", "Packet from %i to %i\n", (int )mine->source, (int )sim_node());
  sim_log_debug(184U, "PHY_layer_check", "Packet from %i to %i ;;; mine->lost:%d\n", (int )mine->source, (int )sim_node(), mine->lost);
#line 401
  if (mine->channel != sim_mote_get_radio_channel(sim_node())) {
      sim_log_debug(185U, "PHY_layer_check", "check channel false\n ");
...
#line 415
      ...
      sim_log_debug(186U, "CpmModelC", "  -signaling reception\n");
      sim_log_debug(187U, "PHY_layer_check", "-signaling reception\n");
...
#line 469
  ...
  sim_log_debug(194U, "CpmModelC", "src: %i, node: %i ,rcv->strength:%i\n", source, sim_node(), rcv->strength);
  ...
  if (!sim_mote_is_on(sim_node())) {
      sim_log_debug(195U, "CpmModelC", "Lost packet from %i due to %i being off\n", source, sim_node());
      rcv->lost = 1;
    }
  else {
#line 496
    if (!CpmModelC__shouldReceive(power - noiseStr)) {
        sim_log_debug(196U, "CpmModelC,SNRLoss", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
        sim_log_debug(197U, "PHY_layer_check", "Lost packet from %i to %i due to SNR being too low (%i)\n", source, sim_node(), (int )(power - noiseStr));
...
#line 526
  ...
  while (list != (void *)0) {
      ...
      if (!CpmModelC__shouldReceive(list->power - rcv->power)) {
          sim_log_debug(199U, "Gain,SNRLoss", "Going to lose packet from %i with signal %lf as am receiving a packet from %i with signal %lf\n", list->source, list->power, source, rcv->power);
          list->lost = 1;
        }
      list = list->next;
    }
...
#line 548
  sim_log_debug(200U, "CpmModelC", "Enqueing reception event for %i at %llu with power %lf.\n", dest, endTime, power);
  sim_set_node(dest);
...
#line 141
  sim_log_debug(168U, "CpmModelC", "IN: noise_hash_generation() with CT: %f and channel id: %d and sensor id: %d\n", CT, sim_mote_get_radio_channel(node_id), node_id);
  ...
  sim_log_debug(169U, "CpmModelC", "@ %s: OUT: noise_hash_generation(): %lf\n", sim_time_string(), noise_val);
...
#line 252
  sim_log_debug(174U, "CpmModelC", "SNR is %lf, PRR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1;
    }
  else {
...
#line 121
  if (__nesc_ntoh_uint16(header->dest.nxdata) == TossimActiveMessageC__amAddress()) {
      sim_log_debug(220U, "Acks", "Received packet addressed to me so ack it\n");
      return TRUE;
    }
  return FALSE;
}

# 489 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline bool PureTDMASchedulerP__TossimPacketModel__shouldAck(message_t *msg)
#line 489
{
}
...
#line 170
  sim_log_debug(170U, "CpmModelC,SNRLoss", "SNR is %lf, ARR is %lf\n", SNR, prr_hat);
  if (prr_hat > 1) {
    prr_hat = 1;
    }
  else {
...
#line 40
# 917 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__Txdelay__fired(void )
#line 917
{
  uint32_t current_slot;
...
#line 153
    {
      sim_log_debug(149U, "test", "GenericSlotSenderP. Delay Tx success\n");
    }
}
...
#line 55
# 934 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__CCATxdelay__fired(void )
#line 934
{
  uint32_t current_slot;
...
#line 941
          PureTDMASchedulerP__Tx_count[sim_node()][PureTDMASchedulerP__Transmitting_flowid[sim_node()]] = PureTDMASchedulerP__Tx_count[sim_node()][PureTDMASchedulerP__Transmitting_flowid[sim_node()]] + 1;
          sim_log_debug(137U, "transmission", "Tx_count[%d]:%d at slot %d\n", PureTDMASchedulerP__Transmitting_flowid[sim_node()], PureTDMASchedulerP__Tx_count[sim_node()][PureTDMASchedulerP__Transmitting_flowid[sim_node()]], current_slot);
        }
      else {
        }
    }
...
# 67 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0x2b363dc85670, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0x2b363dc85670, msg, payload, len);
#line 67
...
# 738 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void *PureTDMASchedulerP__Send__getPayload(message_t *msg, uint8_t len)
#line 738
{
...
# 124 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void * /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__getPayload(am_id_t arg_0x2b363dd3d1a0, message_t * msg, uint8_t len){
#line 124
  void *__nesc_result;
#line 124

#line 124
  __nesc_result = AsyncSendAdapterP__AMSend__getPayload(arg_0x2b363dd3d1a0, msg, len);
#line 124
...
# 67 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/Receive.nc"
inline static message_t * AsyncReceiveAdapterP__Receive__receive(am_id_t arg_0x2b363d43ca78, message_t * msg, void * payload, uint8_t len){
#line 67
  nx_struct message_t *__nesc_result;
#line 67

#line 67
  switch (arg_0x2b363d43ca78) {
#line 67
    case 5:
#line 67
...
#line 67
    default:
#line 67
      __nesc_result = AsyncReceiveAdapterP__Receive__default__receive(arg_0x2b363d43ca78, msg, payload, len);
#line 67
      break;
#line 67
    }
...
#line 52
# 747 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__Receive__updateBuffer(message_t *msg)
#line 747
{
#line 747
...
# 99 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static void AsyncSendAdapterP__AMSend__sendDone(am_id_t arg_0x2b363d428a00, message_t * msg, error_t error){
#line 99
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2b363d428a00, msg, error);
#line 99
}
#line 99
...
#line 117
# 317 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__RadioPowerControl__stopDone(error_t error)
#line 317
{
...
# 761 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__CC2420Config__syncDone(error_t error)
#line 761
{
}
...
# 711 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline void PureTDMASchedulerP__ReadRssi__readDone(error_t result, uint16_t val)
{
  sim_log_debug(134U, "RSSI_TEST", "ReadRssi.readDone: %d\n", (int16_t )val - 45);
}
...
# 89 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2b363dd3e020, message_t * msg, error_t error){
#line 89
  switch (arg_0x2b363dd3e020) {
#line 89
    case 0U:
#line 89
...
#line 89
    default:
#line 89
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2b363dd3e020, msg, error);
#line 89
      break;
#line 89
    }
...
# 64 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2b363d011328){
#line 64
  switch (arg_0x2b363d011328) {
#line 64
...
#line 64
    default:
#line 64
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0x2b363d011328);
#line 64
      break;
#line 64
    }
...
#line 56
# 491 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static inline error_t PureTDMASchedulerP__Send__send(message_t *msg, uint8_t len)
#line 491
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 69 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2b363dd3d1a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 69
  unsigned char __nesc_result;
#line 69

#line 69
  __nesc_result = AsyncSendAdapterP__AMSend__send(arg_0x2b363dd3d1a0, addr, msg, len);
#line 69
...
#line 46
  {
    sim_log_debug(138U, "Init", "LEDS: initialized.\n");
...
# 949 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static uint32_t PureTDMASchedulerP__SuperframeLength(uint32_t Task_set[][3])
#line 949
{
  uint8_t i;
...
#line 72
  sim_log_debug(203U, "QueueC", "head <-");
...
#line 77
          sim_log_debug_clear(205U, "QueueC", "%0.2hhx", v);
        }
      sim_log_debug_clear(206U, "QueueC", "] ");
    }
  sim_log_debug_clear(207U, "QueueC", "<- tail\n");
}
...
#line 557
  ...
  sim_log_debug(201U, "CpmModelC", "Node %i transmitting to %i, finishes at %llu, at channel: %d\n", sim_node(), dest, endTime, channel_id);
  while (neighborEntry != (void *)0) {
      int other = neighborEntry->mote;

      sim_log_debug(202U, "CpmModelC", "Node %i with neighborEntry:%d.\n", sim_node(), neighborEntry->mote);
...
#line 311
  ...
  while (list != (void *)0) {
      ...
      sim_log_debug(178U, "CpmModelC", "packetReceive: outstanding from %d\n", list->source);
      count++;
  ...
  sim_log_debug(179U, "CpmModelC", "packetReceive: outstanding count %d noise %lf at %lf\n", count, noise, (double )sim_time() / sim_ticks_per_sec());
  return noise;
}
...
#line 230
{
  ...
  ackEvent->data = r;
  sim_log_debug(173U, "PHY_layer_check", "+++ ackEvent->data:%d\n", ackEvent->data);
...
#line 43
{
  sim_log_debug(166U, "CC2420Config", "CC2420Config: sync: autoAck %d, hwAutoAck %d\n", CC2420ControlP__autoAck[sim_node()], CC2420ControlP__hwAutoAck[sim_node()]);
...
#line 71
# 883 "/home/sihoon/WCPSv3-master/TinyOS-2.x-jhu/opt/tinyos-2.x/apps/wustl/upma/lib/macs/pure-tdma/PureTDMASchedulerP.nc"
static void PureTDMASchedulerP__transmission(uint8_t Txing_flowid)
#line 883
{
...
#line 87
  ...
  sim_log_debug(148U, "test", "Before transmission\n");
  /* atomic removed: atomic calls only */
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  PureTDMASchedulerP__superframe_length[__nesc_mote] = 50;
  ...
  memcpy((void *)&PureTDMASchedulerP__Task_character[__nesc_mote], (void *)&(unsigned int [4][3]){ { 0, 0, 0 }, { 25, 25, 2 }, { 25, 25, 2 } }, sizeof PureTDMASchedulerP__Task_character[__nesc_mote]);
