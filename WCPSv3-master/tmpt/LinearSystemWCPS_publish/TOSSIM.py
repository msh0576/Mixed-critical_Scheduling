...
class Tossim(_object):
    ...
    #added by sihoon
    def rcvSendNodeid(self): return _TOSSIM.Tossim_rcvSendNodeid(self)
    def setEvent(self, *args): return _TOSSIM.Tossim_setEvent(self, *args)
    def setEvent2(self, *args): return _TOSSIM.Tossim_setEvent2(self, *args)
    def setEvent3(self, *args): return _TOSSIM.Tossim_setEvent3(self, *args)
    def setEvent4(self, *args): return _TOSSIM.Tossim_setEvent4(self, *args)
