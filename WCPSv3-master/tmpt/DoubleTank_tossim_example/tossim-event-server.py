        ...
        while True:
            ...
            if data:
            	...
            	while (t.time() <= 97656250*run_count): # here the 97656250 represents 10ms
            		rcved = t.runNextEvent() #return 2 or 4 or 8 or 16 ... when gateway or actuator receive data.
            		#print("rcved:",rcved)
            		if rcved == 2:
				...
				#print("Current slot time:{0}ms~{1}ms".format((run_count-1)*10,run_count*10))
